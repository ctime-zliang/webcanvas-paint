...
import { DrawActionPanel } from './drawActionPanel/Index'
...
export type D2FreeTestIndexProps = {
	iframeId: string
	iframeUrl: string
	onTurnBackAction?: () => void
}
export function D2FreeTestIndex(props: D2FreeTestIndexProps): React.ReactElement {
	...
	return (
		<main style={{ position: 'relative' }} data-flush={flush}>
