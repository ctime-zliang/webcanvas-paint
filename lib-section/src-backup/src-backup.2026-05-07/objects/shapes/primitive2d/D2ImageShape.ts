...
import { buildD2ImageModel, D2ImageModel, TBuildD2ImageModelOptionalParam } from '../../models/primitive2d/D2ImageModel'
...
export function buildD2ImageShape(
	...
	const elementModelItem: D2ImageModel = buildD2ImageModel(layerItemId, position, fileHashUuid, imageDataURL, width, height, optional)
...
export class D2ImageShape extends D2ElementShapeItemBase {
	...
	public set position(value: Vector2) {
		;(this.model as D2ImageModel).updatePosition(value)
		this.updateBBox2()
		this.refreshRender()
	}
	...
	public get alpha(): number {
		return (this.model as D2ImageModel).alpha
	}
	public set alpha(value: number) {
		;(this.model as D2ImageModel).alpha = value
		this.refreshRender()
	}
	...
	public set rotation(value: number) {
		;(this.model as D2ImageModel).updateRotation(value)
		this.updateBBox2()
		this.refreshRender()
	}
	...
	public set isFlipX(value: boolean) {
		;(this.model as D2ImageModel).updateIsFlipX(value)
		this.updateBBox2()
		this.refreshRender()
	}
	...
	public set isFlipY(value: boolean) {
		;(this.model as D2ImageModel).updateIsFlipY(value)
		this.updateBBox2()
		this.refreshRender()
	}

	public get isShowStroke(): boolean {
		return (this.model as D2ImageModel).isShowStroke
	}
	public set isShowStroke(value: boolean) {
		;(this.model as D2ImageModel).isShowStroke = value
		this.refreshRender()
	}
	...
	public updateCacheTransform(): void {
		const model: D2ImageModel = this.model as D2ImageModel
