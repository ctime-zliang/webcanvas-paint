...
export abstract class D2ShapeElementViewBase extends Context {
	private _type: ED2ElementType
	private _layerItemId: string
	private _elementItemId: string
	private _shapeObjectItem: D2ElementShapeItemBase
	constructor(shapeObjectItem: D2ElementShapeItemBase) {
	...
	public get shapeObjectItem(): D2ElementShapeItemBase {
		return this._shapeObjectItem
	}

	abstract modify(shapeObjectItem: D2ElementShapeItemBase): any
