...
export class FloatPanel {
	public static createContainer(container: HTMLElement, position: 'LT' | 'RT' | 'LB' | 'RB' = 'RB'): HTMLElement {
	...
	public static inputsPanelControl = {
	...
	public static canvasProfilePanelControl = {
