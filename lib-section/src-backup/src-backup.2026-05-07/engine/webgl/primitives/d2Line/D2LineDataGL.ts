...
export class D2LineDataGL {
	public static ITEM_SIZE: number = 19
	public static STRIDE: number = 19 * FLOAT_32_ARRAY_BYTESIZE
	public static createArrayData(primitiveItemValueData: TElementD2LineJSONData, layerAlpha: number = 1.0): Float32Array {
		const typedArray: Array<number> = [
			...
			primitiveItemValueData.lineCap === ECanvasD2LineCap.ROUND ? 1.0 : 0.0, // 8
			...
			mm2px(primitiveItemValueData.rectBorderRadius, InsConfig.DPI[0]), // 14
			/* ... */
