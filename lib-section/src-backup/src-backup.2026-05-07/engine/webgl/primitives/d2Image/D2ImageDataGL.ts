...
export class D2ImageDataGL {
	public static ITEM_SIZE: number = 14
	public static STRIDE: number = 14 * FLOAT_32_ARRAY_BYTESIZE
	public static createArrayData(primitiveItemValueData: TElementD2ImageJSONData, layerAlpha: number = 1.0): Float32Array {
