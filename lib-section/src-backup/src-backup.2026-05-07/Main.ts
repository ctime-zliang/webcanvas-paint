...
import { ECanvasD2LineCap, ED2FontStyle, ED2PointShape } from './engine/config/PrimitiveProfile'
import { EPointerEventName } from './manager/EventsManager'
import { EOutEventCommand } from './utils/OutMessage'
...
import { OutProfileMessage, TCanvasProfileData, TOpeartionProfileData } from './utils/OutMessage'
...
export * from './algorithm/geometry/D2BezierToolkit'
...
export type BuildD2TextModelOptionalStyleSettingParam = TBuildD2TextModelOptionalStyleSettingParam
...
export type CanvasD2LineCap = ECanvasD2LineCap
export const CANVAS_LINE_CAP = { ...ECanvasD2LineCap }
...
export class WebCanvas {
	...
	public setCanvasZoomRatioByScenePhysicsPos(ratio: number, scenePhysicsPosition?: Vector2): void {
		Constant.canvasController.setCanvasZoomRatioByScenePhysicsPos(ratio, scenePhysicsPosition ? scenePhysicsPosition.toVector3() : undefined)
		OutProfileMessage.dispatchCanvasProfileChangeMessage()
	}
	 ...
	 * 相机中心点
	 */
	public setCameraCenterByCanvasSourceNativePixelPos(canvasDomSourceNativePixelPosition: Vector3): void {
		Constant.canvasController.setCameraCenterByCanvasSourceNativePixelPos(canvasDomSourceNativePixelPosition)
		Constant.messageTool.messageBus.publish(EFrameCommand.RENDER_FRAME, null)
	}
	public setCameraCenterByScenePhysicsPos(scenePhysicsPosition: Vector3): void {
	 ...
	 * 		2. 场景物理坐标
	 */
	public setScenePhysicsPos2CanvasSourceNativePixelPos(scenePhysicsPoint: D2PointItem): D2PointItem {
