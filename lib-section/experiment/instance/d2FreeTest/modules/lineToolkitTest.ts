import { BBox2, CANVAS_LINE_CAP, CanvasD2LineCap, Color, D2LineToolkit, Line, Vector2, WebCanvas } from '../../../../src/Main'
...
export function d2LineToolkitTest05(webCanvas: WebCanvas, layerItemId: string): void {
	...
	/* ... */
	createShapePoints(webCanvas, layerItemId, renderPoints)
	console.log(d2ElementController.getAllD2ElementShapeResults())
}
