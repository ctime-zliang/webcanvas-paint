import { Angles, BuildD2TextModelOptionalStyleSettingParam, Color, D2FONT_STYLE, D2TextVertexData, Element2DTextJSONViewData, ElementJSONData, nextFrameTick, Vector2, WebCanvas } from '../../../../src/Main'
...
export async function drawTextItemStdTest01(webCanvas: WebCanvas, layerItemId: string): Promise<void> {
	...
	d2TextElementController
		...
		.then((d2TextVertexData: D2TextVertexData): void => {
			...
			const shapeElementItemId1: string = d2TextElementController.createD2TextElementItemByVertexData(layerItemId, d2TextVertexData, new Vector2(-50, -50), {
				strokeColor: Color.RED,
				styleSetting,
			})
