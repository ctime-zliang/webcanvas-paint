import { Angles, Color, D2POINT_SHAPE, Element2DImageJSONViewData, ElementJSONData, getHashIden, nextFrameTick, POINT_EVENT_NAME, Vector2, WebCanvas } from '../../../../src/Main'
import { sleep } from '../utils/sleep'
import image01 from '../../public/assets/dS0vD9wJ5eT7mR9zO2nB6zR8vI2xJ2.jpg'
import image02 from '../../public/assets/kA2cK1qT4oT6vX4pW5mC8vK2iT0iD9.png'
import image03 from '../../public/assets/iN5lA1rY4xY1nM9fQ1fH8gX4lX9nZ2.jpg'
import image04 from '../../public/assets/aG3yX1mO9eS3nF0wH7qY7dY8yB9pR0.png'
import image05 from '../../public/assets/eP7eA1sP8bW7aM4sF8wE6lZ6uP9rA8.jpg'
import earth01 from '../../public/assets/earth-01.png'
...
export async function drawImageItemStdTest01(webCanvas: WebCanvas, layerItemId: string): Promise<void> {
	...
	const shapeElementItemIdA1: string = d2ElementController.createD2ImageElementItem(layerItemId, new Vector2(-50, 50), readResult.fileHashUuid, readResult.imageDataURL, sImageWidth, sImageHeight, {
		isFlipX: true,
		isFlipY: true,
...
export async function drawImageItemsTest01(webCanvas: WebCanvas, layerItemId: string): Promise<void> {
	...
	const shapeElementItemIdA1: string = d2ElementController.createD2ImageElementItem(layerItemId, new Vector2(-150, 70), readResult.fileHashUuid, readResult.imageDataURL, sImageWdith, sImageHeight, {
		isFlipX: false,
		isFlipY: false,
		rotation: Angles.degreeToRadian(0),
	})
	const shapeElementItemIdA2: string = d2ElementController.createD2ImageElementItem(layerItemId, new Vector2(-50, 70), readResult.fileHashUuid, readResult.imageDataURL, sImageWdith, sImageHeight, {
		isFlipX: false,
		isFlipY: false,
		rotation: Angles.degreeToRadian(30),
	})
	const shapeElementItemIdA3: string = d2ElementController.createD2ImageElementItem(layerItemId, new Vector2(50, 70), readResult.fileHashUuid, readResult.imageDataURL, sImageWdith, sImageHeight, {
		isFlipX: false,
		isFlipY: false,
		rotation: Angles.degreeToRadian(90),
	})
	const shapeElementItemIdA4: string = d2ElementController.createD2ImageElementItem(layerItemId, new Vector2(150, 70), readResult.fileHashUuid, readResult.imageDataURL, sImageWdith, sImageHeight, {
		isFlipX: false,
		isFlipY: false,
		rotation: Angles.degreeToRadian(120),
	})
	const shapeElementItemIdB1: string = d2ElementController.createD2ImageElementItem(layerItemId, new Vector2(-150, -70), readResult.fileHashUuid, readResult.imageDataURL, sImageWdith, sImageHeight, {
		isFlipX: true,
		isFlipY: true,
		rotation: Angles.degreeToRadian(0),
	})
	const shapeElementItemIdB2: string = d2ElementController.createD2ImageElementItem(layerItemId, new Vector2(-50, -70), readResult.fileHashUuid, readResult.imageDataURL, sImageWdith, sImageHeight, {
		isFlipX: true,
		isFlipY: true,
		rotation: Angles.degreeToRadian(30),
	})
	const shapeElementItemIdB3: string = d2ElementController.createD2ImageElementItem(layerItemId, new Vector2(50, -70), readResult.fileHashUuid, readResult.imageDataURL, sImageWdith, sImageHeight, {
		isFlipX: true,
		isFlipY: true,
		rotation: Angles.degreeToRadian(90),
	})
	const shapeElementItemIdB4: string = d2ElementController.createD2ImageElementItem(layerItemId, new Vector2(150, -70), readResult.fileHashUuid, readResult.imageDataURL, sImageWdith, sImageHeight, {
		isFlipX: true,
		isFlipY: true,
		rotation: Angles.degreeToRadian(120),
	})
