...
import { D2ArcShaderGL } from './D2ArcShaderGL'
import { D2ArcDataGL } from './D2ArcDataGL'

const INIT_INDEX_DATA: Array<number> = [0, 1, 2]

export class D2ArcInstancedProgramGL extends InstancedProgramGL {
	private readonly _a_objPosition: number
	private readonly _a_param: number
	private readonly _a_angle: number
