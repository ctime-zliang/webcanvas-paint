...
export class D2CircleDataGL {
	public static ITEM_SIZE: number = 17
	public static STRIDE: number = 17 * FLOAT_32_ARRAY_BYTESIZE
	public static createArrayData(primitiveItemValueData: TElementD2CircleJSONData, layerAlpha: number = 1.0): Float32Array {
		...
		const typedArray: Array<number> = [
			...
			primitiveItemValueData.lineCap === ECanvasD2LineCap.ROUND ? 1.0 : 0.0, // 6
