...
export class OutProfileMessage {
	...
	public static dispatchOperationProfileChangeMessage(action: EOperationAction, params: any = {}): void {
	...
	public static createOperationProfileData(action: EOperationAction, params: any = {}): TOpeartionProfileData {
		return {
			action,
			...params,
		}
