...
export class D2TextDataGL {
	public static ITEM_SIZE: number = 11
	public static STRIDE: number = 11 * FLOAT_32_ARRAY_BYTESIZE
	public static createArrayData(primitiveItemValueData: TElementD2TextJSONData, layerAlpha: number = 1.0): Float32Array {
	...
	public static createIndicesData(primitiveItemValueData: TElementD2TextJSONData): Uint16Array {
