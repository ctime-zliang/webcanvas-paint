...
export class D2PointDataGL {
	public static ITEM_SIZE: number = 13
	public static STRIDE: number = 13 * FLOAT_32_ARRAY_BYTESIZE
	public static createArrayData(primitiveItemValueData: TElementD2PointJSONData, layerAlpha: number = 1.0): Float32Array {
		const typedArray: Array<number> = [
			...
			primitiveItemValueData.isEnableScale ? 1.0 : 0.0, // 6
			primitiveItemValueData.shape === ED2PointShape.DOT ? 1.0 : 2.0, // 7
			primitiveItemValueData.rotation, // 8
			/* ... */
