...
export class EnvirInit {
	public static async init(canvasElement: HTMLCanvasElement): Promise<void> {
...
export class D2ToolInit {
	private static eventsLoader: EventsLoader
	private static d2FrameTool: D2FrameTool
	private static drawD2ToolManager: DrawD2ToolManager

	public static d2Init(canvasElement: HTMLCanvasElement): {
