...
import { D2ElementShapeItemBase } from '../primitive2d/elementBase/D2ElementShapeItemBase'
...
export class DrawLayerShapeManager extends BaseManager<DrawLayerShape> {
	...
	public deleteContentShapeItem(layerItemId: string): void {
		...
		const allElementShapes: Array<D2ElementShapeItemBase> = Helper.getAllElementShapes()
