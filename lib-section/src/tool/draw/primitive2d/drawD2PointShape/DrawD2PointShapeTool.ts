...
import { DrawD2PointShape } from './DrawD2PointShape'

export class DrawD2PointShapeTool extends DrawD2ShapeTool {
	private _drawShapeHandler: DrawD2PointShape
	constructor() {
		super({})
	...
	public mouseLeftUpHandler(inputInfo: InputInfo): void {
		...
		if (!this.isDrawing) {
			...
			const items: Array<D2PointShape> = this._drawShapeHandler.completeDraw()
