...
import { DrawD2ArcShape } from './DrawD2ArcShape'

export class DrawD2ArcShapeTool extends DrawD2ShapeTool {
	private _drawShapeHandler: DrawD2ArcShape
	constructor() {
		super({})
	...
	public mouseLeftUpHandler(inputInfo: InputInfo): void {
		...
		if (!this.isDrawing) {
			...
			const items: Array<D2ArcShape> = this._drawShapeHandler.completeDraw()
