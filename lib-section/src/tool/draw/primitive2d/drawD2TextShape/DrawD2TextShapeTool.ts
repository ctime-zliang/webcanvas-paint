...
import { DrawD2TextShape } from './DrawD2TextShape'

export class DrawD2TextShapeTool extends DrawD2ShapeTool {
	private _drawShapeHandler: DrawD2TextShape
	...
	public mouseLeftUpHandler(inputInfo: InputInfo): void {
		...
		if (!this.isDrawing) {
			...
			if (this._drawShapeHandler && this._drawShapeHandler.isShapeInsatncesContentReady()) {
				...
				const items: Array<D2TextShape> = this._drawShapeHandler.completeDraw()
