...
import { DrawD2RectShape } from './DrawD2RectShape'

export class DrawD2RectShapeTool extends DrawD2ShapeTool {
	private _drawShapeHandler: DrawD2RectShape
	constructor() {
		super({})
	...
	public mouseLeftUpHandler(inputInfo: InputInfo): void {
		...
		if (!this.isDrawing) {
			...
			const items: Array<D2RectShape> = this._drawShapeHandler.completeDraw()
