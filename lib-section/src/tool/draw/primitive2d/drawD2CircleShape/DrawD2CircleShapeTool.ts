...
import { DrawD2CircleShape } from './DrawD2CircleShape'

export class DrawD2CircleShapeTool extends DrawD2ShapeTool {
	private _drawShapeHandler: DrawD2CircleShape
	constructor() {
		super({})
	...
	public mouseLeftUpHandler(inputInfo: InputInfo): void {
		...
		if (!this.isDrawing) {
			...
			const items: Array<D2CircleShape> = this._drawShapeHandler.completeDraw()
