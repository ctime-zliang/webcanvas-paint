...
import { D2RectShapeCommand } from '../../history/command/primitive2d/D2RectShapeCommand'
...
export class D2RectShapeSelectionTool extends D2SelectionTool {
	private _shapeItemCommand: D2RectShapeCommand
	private _selectedItem: D2RectShape
	...
	constructor(selectedItem: D2RectShape) {
		super()
	...
	public mouseMoveHandler(inputInfo: InputInfo): void {
		...
		if (this._isSelectedPointLeftUp) {
			...
			this._selectedItem.position = this._selectedItem.position.multiplyMatrix4(matrix4)
